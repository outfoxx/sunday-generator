...
val SUNDAY_STREAMING_BODY = ClassName.bestGuess("io.outfoxx.sunday.StreamingBody")
val SUNDAY_STREAMING_OPERATION = ClassName.bestGuess("io.outfoxx.sunday.StreamingOperation")
...
val SUNDAY_BROKER_CONSUME_SPEC = ClassName.bestGuess("io.outfoxx.sunday.broker.BrokerConsumeSpec")
val SUNDAY_BROKER_CONSUMER = ClassName.bestGuess("io.outfoxx.sunday.broker.BrokerConsumer")
val SUNDAY_BROKER_DELIVERY = ClassName.bestGuess("io.outfoxx.sunday.broker.BrokerDelivery")
val SUNDAY_BROKER_DECODE_FAILURE_HANDLER = ClassName.bestGuess("io.outfoxx.sunday.broker.BrokerDecodeFailureHandler")
val SUNDAY_BROKER_MESSAGE_CODEC = ClassName.bestGuess("io.outfoxx.sunday.broker.BrokerMessageCodec")
val SUNDAY_BROKER_PRODUCER = ClassName.bestGuess("io.outfoxx.sunday.broker.BrokerProducer")
val SUNDAY_BROKER_SEND_SPEC = ClassName.bestGuess("io.outfoxx.sunday.broker.BrokerSendSpec")
val SUNDAY_AMQP_BROKER_PROTOCOL_SPEC = ClassName.bestGuess("io.outfoxx.sunday.broker.AmqpBrokerProtocolSpec")
