...
val STREAMING_BODY = TypeName.namedImport("StreamingBody", SUNDAY_PKG)
val STREAMING_OPERATION = TypeName.namedImport("StreamingOperation", SUNDAY_PKG)
...
val CREATE_STREAMING_OPERATION = SymbolSpec.importsName("createStreamingOperation", SUNDAY_PKG)
