...
/**
 * Source-produced API fragment before multi-spec composition.
 */
data class GeneratedApiFragment(
  val api: GeneratedApi,
  val apiId: GeneratedIdentity,
  val serviceIdentities: Map<String, GeneratedIdentity> = mapOf(),
