...
/**
 * Swift type registry surface required by IR-backed emitters.
 */
interface SwiftTypeOutputRegistry {

  val options: Set<SwiftTypeRegistry.Option>
  ...
  fun getReferenceType(className: TypeName): TypeName?

  fun addReferenceType(
    className: TypeName,
