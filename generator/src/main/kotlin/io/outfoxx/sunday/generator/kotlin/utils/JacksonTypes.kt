...
val JACKSON_JSON_IGNORE_PROPERTIES = ClassName.bestGuess("com.fasterxml.jackson.annotation.JsonIgnoreProperties")
...
val JACKSON_JSON_VALUE = ClassName.bestGuess("com.fasterxml.jackson.annotation.JsonValue")
val JACKSON_JSON_DESERIALIZE = ClassName.bestGuess("com.fasterxml.jackson.databind.annotation.JsonDeserialize")
val JACKSON_JSON_SERIALIZE = ClassName.bestGuess("com.fasterxml.jackson.databind.annotation.JsonSerialize")
val JACKSON_JSON_DESERIALIZER = ClassName.bestGuess("com.fasterxml.jackson.databind.JsonDeserializer")
val JACKSON_JSON_SERIALIZER = ClassName.bestGuess("com.fasterxml.jackson.databind.JsonSerializer")
val JACKSON_JSON_DESERIALIZER_NONE = ClassName.bestGuess("com.fasterxml.jackson.databind.JsonDeserializer.None")
val JACKSON_JSON_MAPPING_EXCEPTION = ClassName.bestGuess("com.fasterxml.jackson.databind.JsonMappingException")
val JACKSON_JSON_PARSER = ClassName.bestGuess("com.fasterxml.jackson.core.JsonParser")
val JACKSON_JSON_GENERATOR = ClassName.bestGuess("com.fasterxml.jackson.core.JsonGenerator")
val JACKSON_DESERIALIZATION_CONTEXT = ClassName.bestGuess("com.fasterxml.jackson.databind.DeserializationContext")
val JACKSON_SERIALIZER_PROVIDER = ClassName.bestGuess("com.fasterxml.jackson.databind.SerializerProvider")
val JACKSON_TYPE_SERIALIZER = ClassName.bestGuess("com.fasterxml.jackson.databind.jsontype.TypeSerializer")
...
val OBJECT_NODE = ClassName.bestGuess("com.fasterxml.jackson.databind.node.ObjectNode")
