...
public class APIResource @Inject constructor(
  ...
  @Path(value = "/created")
  @Authenticated
  public fun created(@Context uriInfo: UriInfo): RestResponse<Unit> = this.delegate.created(uriInfo)
  ...
  @Authenticated
  public fun sse(@Context sse: Sse, @Context sseEvents: SseEventSink) {
