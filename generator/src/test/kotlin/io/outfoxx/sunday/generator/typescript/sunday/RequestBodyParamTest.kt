...
class RequestBodyParamTest {
  ...
  @Test
  fun `test generation of body parameter`(
    ...
    assertSnapshot("RequestBodyParamTest/req-body-param.api.ts", output)
  }
  ...
  fun `test generation of inline set body and return types`(
    ...
    assertSnapshot("RequestBodyParamTest/req-body-param-set-inline.api.ts", output)
  }
}
