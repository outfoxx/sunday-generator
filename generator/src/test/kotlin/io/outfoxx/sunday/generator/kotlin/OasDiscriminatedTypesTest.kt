...
class OasDiscriminatedTypesTest {

  @Test
  fun `test polymorphism added to generated interfaces of string discriminated types`(
    @ResourceUri("openapi/type-gen/discriminated/simple.yaml") testUri: URI
  ) {
  ...
  fun `test polymorphism added to generated interfaces of enum discriminated types`(
    @ResourceUri("openapi/type-gen/discriminated/enum.yaml") testUri: URI
  ) {
