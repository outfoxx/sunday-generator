...
class OasTypeAnnotationsTest {
  ...
  fun `test type annotations`(
    ...
    val testOasFile = "openapi/type-gen/annotations/type-${testAnnName}.yaml"
    val testUri = resourceClassLoader.getResource(testOasFile)?.toURI()
      ?: fail("unable to find test OpenAPI file: $testOasFile")
  ...
  fun `test class hierarchy generated for 'nested' annotation`(
    @ResourceUri("openapi/type-gen/annotations/type-nested.yaml") testUri: URI
  ) {

    val typeRegistry = KotlinTypeRegistry("io.test", Server, setOf())

    val typeSpec = findType("io.test.Group", generateTypes(testUri, typeRegistry, SchemaMode.OpenAPI3))
  ...
  fun `test class hierarchy generated for 'nested' annotation using library types`(
    @ResourceUri("openapi/type-gen/annotations/type-nested-lib.yaml") testUri: URI
  ) {

    val typeRegistry = KotlinTypeRegistry("io.test", Server, setOf())

    val typeSpec = findType("io.test.Root", generateTypes(testUri, typeRegistry, SchemaMode.OpenAPI3))
  ...
  fun `test class generated kotlin implementations`(
    @ResourceUri("openapi/type-gen/annotations/type-kotlin-impl.yaml") testUri: URI
  ) {
  ...
  fun `test class hierarchy generated for externally discriminated types`(
    @ResourceUri("openapi/type-gen/annotations/type-external-discriminator.yaml") testUri: URI
  ) {
  ...
  fun `test external discriminator must exist`(
    @ResourceUri("openapi/type-gen/annotations/type-external-discriminator-invalid.yaml") testUri: URI
  ) {
    ...
    val exception =
      assertThrows<IllegalStateException> {
        generateTypes(testUri, typeRegistry, SchemaMode.OpenAPI3)
      }
  ...
  fun `test patchable class generation`(
    @ResourceUri("openapi/type-gen/annotations/type-patchable.yaml") testUri: URI
  ) {
