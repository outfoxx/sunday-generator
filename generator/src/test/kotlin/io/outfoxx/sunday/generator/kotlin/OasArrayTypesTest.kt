...
class OasArrayTypesTest {

  @Test
  fun `test generated nullability of array types and elements in interfaces`(
    @ResourceUri("openapi/type-gen/types/arrays-nullability.yaml") testUri: URI
  ) {
  ...
  fun `test generated collection interface`(
    @ResourceUri("openapi/type-gen/types/arrays-collection.yaml") testUri: URI
  ) {
  ...
  fun `test generated primitive class`(
    @ResourceUri("openapi/type-gen/types/arrays-primitive.yaml") testUri: URI
  ) {
