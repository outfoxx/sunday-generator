...
class RamlArrayTypesTest {
  ...
  fun `test generated nullability of array types and elements`(
    ...
    assertSwiftSnapshot(
      "RamlArrayTypesTest/test-generated-nullability-of-array-types-and-elements.output.swift",
      buildString {
        FileSpec
          .get("", typeSpec)
          .writeTo(this)
  ...
  fun `test generated collections`(
    ...
    assertSwiftSnapshot(
      "RamlArrayTypesTest/test-generated-collections.output.swift",
      buildString {
        FileSpec
          .get("", typeSpec)
          .writeTo(this)
  ...
  fun `test generated primitive`(
    ...
    assertSwiftSnapshot(
      "RamlArrayTypesTest/test-generated-primitive.output.swift",
      buildString {
        FileSpec
          .get("", typeSpec)
          .writeTo(this)
