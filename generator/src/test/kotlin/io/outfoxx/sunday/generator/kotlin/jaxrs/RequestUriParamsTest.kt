...
class RequestUriParamsTest {
  ...
  fun `test basic uri parameter generation with validation constraints`(
    ...
    assertKotlinJaxrsSnapshot(
      "RequestUriParamsTest/test-basic-uri-parameter-generation-with-validation-constraints.output.kt",
      buildString {
        FileSpec
          .get("io.test.service", typeSpec)
          .writeTo(this)
  ...
  fun `test basic uri parameter generation with quarkus option enabled`(
    ...
    assertKotlinJaxrsSnapshot(
      "RequestUriParamsTest/test-basic-uri-parameter-generation-with-quarkus-option-enabled.output.kt",
      buildString {
        FileSpec
          .get("io.test.service", typeSpec)
          .writeTo(this)
  ...
  fun `test basic uri parameter generation with validation constraints and quarkus option enabled`(
    ...
    assertKotlinJaxrsSnapshot(
      "RequestUriParamsTest/test-basic-uri-parameter-generation-with-validation-constraints-and-quarkus-option-enabled.output.kt",
      buildString {
        FileSpec
          .get("io.test.service", typeSpec)
          .writeTo(this)
  ...
  fun `test inherited uri parameter generation with quarkus option enabled`(
    ...
    assertKotlinJaxrsSnapshot(
      "RequestUriParamsTest/test-inherited-uri-parameter-generation-with-quarkus-option-enabled.output.kt",
      buildString {
        FileSpec
          .get("io.test.service", typeSpec)
          .writeTo(this)
  ...
  fun `test optional uri parameter generation with quarkus option enabled`(
    ...
    assertKotlinJaxrsSnapshot(
      "RequestUriParamsTest/test-optional-uri-parameter-generation-with-quarkus-option-enabled.output.kt",
      buildString {
        FileSpec
          .get("io.test.service", typeSpec)
          .writeTo(this)
  ...
  fun `test generation of multiple uri parameters with inline type definitions and quarkus option enabled`(
    ...
    assertKotlinJaxrsSnapshot(
      "RequestUriParamsTest/test-generation-of-multiple-uri-parameters-with-inline-type-definitions-and-quarkus-option-enabled.output.kt",
      buildString {
        FileSpec
          .get("io.test.service", typeSpec)
          .writeTo(this)
